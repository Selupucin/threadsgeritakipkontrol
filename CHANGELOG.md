...
## [1.2.3] — 2026-06-22
### Değişti
- Popup tasarımı rötuşlandı: yuvarlatılmış pencere kenarları, kompakt başlık (alt yazı kaldırıldı). Görsel hiyerarşi düzeltildi — **Kontrol Et** butonu öne çıkarıldı (en parlak öğe), "Yenilikler" kartı sakin/sönük tona alındı.
